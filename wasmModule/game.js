...
function(createGameModule) {
  createGameModule = createGameModule || {};
...
var Module = typeof createGameModule != 'undefined' ? createGameModule : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_knightAttack')) {
        Object.defineProperty(Module['ready'], '_knightAttack', { configurable: true, get: function() { abort('You are getting _knightAttack on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_knightAttack', { configurable: true, set: function() { abort('You are setting _knightAttack on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_archerAttack')) {
        Object.defineProperty(Module['ready'], '_archerAttack', { configurable: true, get: function() { abort('You are getting _archerAttack on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_archerAttack', { configurable: true, set: function() { abort('You are setting _archerAttack on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_dragonAttack')) {
        Object.defineProperty(Module['ready'], '_dragonAttack', { configurable: true, get: function() { abort('You are getting _dragonAttack on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_dragonAttack', { configurable: true, set: function() { abort('You are setting _dragonAttack on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_dragonHeal')) {
        Object.defineProperty(Module['ready'], '_dragonHeal', { configurable: true, get: function() { abort('You are getting _dragonHeal on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_dragonHeal', { configurable: true, set: function() { abort('You are setting _dragonHeal on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _knightAttack = Module["_knightAttack"] = createExportWrapper("knightAttack");

/** @type {function(...*):?} */
var _archerAttack = Module["_archerAttack"] = createExportWrapper("archerAttack");

/** @type {function(...*):?} */
var _dragonAttack = Module["_dragonAttack"] = createExportWrapper("dragonAttack");

/** @type {function(...*):?} */
var _dragonHeal = Module["_dragonHeal"] = createExportWrapper("dragonHeal");
...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return createGameModule; });
